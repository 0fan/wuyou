    ...
    return (
      <div className = { style.protocol }>
        ...
        <Row gutter = { 10 } className = { style.footer }>
          <Col span = { 12 }><Button onClick = { e => Toast.fail('不同意可不行', 3, null, false) } size = 'large'>不同意</Button></Col>
          <Col span = { 12 }><Button onClick = { e => this.props.history.push(`/building/${ id }/track/progress`) } size = 'large' type = 'primary'>已阅读并同意授权</Button></Col>
        </Row>
      </div>
    )
  }
